...
<div class="card card-success">
    ...
    <form action="{{route('update', $agency->id)}}" method="post" enctype="multipart/form-data">
        @csrf
        <div class="card-body">
            <div class="form-group">
                <label for="inputName">Tên đại lí</label>
                <input type="text" value="{{$agency->name}}" name="name" id="inputName"
            ...
            <div class="form-group">
                ...
                <input type="text" value="{{$agency->email}}" id="inputClientCompany" name="email"
            ...
            <div class="form-group">
                <label for="inputDescription">Số điện thoại</label>
                <input type="number" value="{{$agency->phone}}" name="phone" id="inputDescription"
            ...
            <div class="form-group">
                ...
                <div class="input-group mb-3">
                    <input type="text" value="{{$agency->address}}" id="inputClientCompany" name="address"
            ...
            <div class="form-group">
                ...
                <input type="text" value="{{$agency->manager}}" name="manager" id="inputDescription"
